    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if rke_guided_sampler is not None and criteria_guidance_scale != 0 and clap_for_guidance is not None:
                    ...
                    if i % guidance_freq == 0 and criteria == 'vscore_clap':
                        grads, F_M, F_T = rke_guided_sampler.cond_fn(
                            ...
                            prompt_embeds=txt_embd_for_guidance,
        ...
        # **** SPARKE KERNEL RETURN ****
        if return_kernels:
            return (audio, F_M, F_T)
