...
Approaches =["cond-vendi-FKEA","cond-vendi-CSA","cond-vendi","cond-rke"]

# 3. SET UP RKE GUIDED SAMPLING

for approach in Approaches:
    print(f"Running SPARKE AudioLDM2 Generation with approach: {approach}")
    ...
    guidance_kwargs = dict(
        num_inference_steps=200,      # 200 is recommended by Declare-Lab for Tango/Tango2
    ...
    output_dir = f"tango_sounds_sparke4_new_{approach}"
