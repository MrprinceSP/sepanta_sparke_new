...
class Tango:
    def __init__(self, name="declare-lab/tango", device="cuda:0"):
        ...
        unet_config_path = os.path.join(os.path.dirname(__file__), 'configs', 'diffusion_model_config.json')
